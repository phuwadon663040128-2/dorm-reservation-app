...
const accountAction = computed(() => {
  ...
  return { label: 'ไปเลือกหอและห้องพัก', to: '/app/rooms' }
})
...
const checklist = [
  ...
  'ข้อมูลประจำตัวและช่องทางติดต่อสำหรับกรอกใบสมัครภายหลัง',
  'ชื่อหรืออีเมลของรูมเมท (กรณีต้องการพักคู่)',
  'เปรียบเทียบหอ ประเภทห้อง และค่าธรรมเนียมล่วงหน้า',
]

const steps = [
  { icon: UserRoundPlusIcon, title: 'สร้างบัญชีและยืนยันอีเมล', detail: 'สมัครด้วยอีเมลส่วนตัวและยืนยันอีเมลให้เรียบร้อย จากนั้นเริ่มเลือกหอพักและห้องว่างได้ทันที โดยยังไม่ต้องกรอกใบสมัคร' },
  ...
  { icon: FilePenLineIcon, title: 'กรอกและส่งใบสมัคร', detail: 'หลังชำระรายการของตนเองแล้ว ระบบพาไปกรอกใบสมัคร พร้อมเติมชื่อหอ อาคาร ชั้น ประเภทห้อง เลขห้อง และรูปแบบการพักจากการจองให้อัตโนมัติ' },
