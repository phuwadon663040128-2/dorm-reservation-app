...
const campaignList = ref<DormCampaign[]>([
  {
    ...
    status: 'open',
    description: 'หอพักวรเรสซิเดนซ์ (หอ 8 หลัง) แบ่งเป็นหอพักชาย 2 หลังและหอพักหญิง 6 หลัง มีห้องพัดลมและห้องแอร์ พร้อมสิ่งอำนวยความสะดวกครบครัน',
    openDate: '2026-06-01',
  ...
  },
  {
    ...
    type: 'หอพักในกำกับ มข.',
    status: 'open',
    description: 'หอพักนพรัตน์ มหาวิทยาลัยขอนแก่น แบ่งเป็นหอพักชาย 4 หลังและหอพักหญิง 5 หลัง ให้สิทธิ์ทั้งนักศึกษาปี 1 และนักศึกษาเก่าต่อสัญญาเดิมตามรอบรับสมัคร',
    openDate: '2026-06-05',
