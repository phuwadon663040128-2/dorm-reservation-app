...
export interface PlanOverlay {
  ...
  cropW: number
  cropH: number
  /** มุมทิศเหนือบนแบบแปลน (องศาตามเข็มนาฬิกาจากด้านบนของภาพ — 0 = ชี้ขึ้น, 180 = ชี้ลง) */
  northAngle: number
...
const overlays: Record<string, PlanOverlay> = {
  'dorm-8-lang:1:1': {
    ...
    // แบบแปลนวาดปีกไว้ด้านบนกระดาษ → ทิศเหนือจริงอยู่ด้านล่างของภาพ
    northAngle: 180,
    northNote: 'ทิศเหนืออยู่ด้านล่างของแบบแปลน (เทียบตำแหน่งอาคารบน Google Maps — ปีกหลังตึกหันเข้าคอร์ทกลางทางทิศใต้) · การจับคู่เลขอาคารกับตำแหน่งจริงรอข้อมูลยืนยัน',
